...
const BASE_QUESTS = [
  ...
  { id:'base-15', title_de:'Eine ältere Person (mit Einverständnis) nach einer bereuten Erfahrung fragen und ohne Handy zuhören',    title_en:'Ask an older person (with consent) about a regret they learned from, and listen without your phone', category:'social',  tags:['weisheit','zuhören','präsenz'],       duration_min:30,  duration_max:90,   setting:'both',    group_mode:'solo',  adventure_level:3, equipment:['nichts'],                  constraints:{budget_max_chf:0,weather_required:'none'},   instructions_de:['Nur fragen, wenn die Person offen dafür ist.','Mit Empathie zuhören und das Handy weglegen.','Danach eine Lebenslektion notieren.'], instructions_en:['Ask only if they are open to sharing.','Listen with empathy and keep your phone away.','Write down one life lesson afterwards.'], source:'base' },
  ...
  { id:'base-51', title_de:'Entwirf ein AI-Native Banking- und Insurance-Infrastruktur-Konzept', title_en:'Design an AI-native banking and insurance infrastructure concept', category:'creativity', tags:['solo','challenge','low_budget'], duration_min:90, duration_max:180, setting:'indoor', group_mode:'solo', adventure_level:4, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle einen klaren Finanz-Use-Case.','Skizziere in einer Seite Architektur, Datenfluss und Sicherheitsgrenzen.','Definiere drei Risiken plus Mitigationen.'], instructions_en:['Pick one concrete finance use case.','Sketch architecture, data flow, and security boundaries in one page.','Define three risks and mitigations.'], source:'base' },
  { id:'base-52', title_de:'Skizziere eine Enterprise Multi-Agent Orchestration Platform', title_en:'Sketch an enterprise multi-agent orchestration platform', category:'creativity', tags:['solo','creative','challenge'], duration_min:75, duration_max:150, setting:'indoor', group_mode:'solo', adventure_level:4, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Lege drei Agent-Rollen mit klaren Zuständigkeiten fest.','Definiere Übergaben, Eskalationen und einen Human-in-the-Loop-Punkt.','Beschreibe, welche Metriken Qualität und Kosten messen.'], instructions_en:['Define three agent roles with clear responsibilities.','Map handoffs, escalations, and one human-in-the-loop checkpoint.','List metrics to track quality and cost.'], source:'base' },
  { id:'base-53', title_de:'Plane einen Real-World Physical Data Observability Pilot', title_en:'Plan a real-world physical data observability pilot', category:'creativity', tags:['solo','adventure','city'], duration_min:60, duration_max:120, setting:'both', group_mode:'solo', adventure_level:3, equipment:['Notizbuch'], constraints:{budget_max_chf:0,weather_required:'any'}, instructions_de:['Wähle einen physischen Prozess, den man messen kann.','Lege Sensorpunkte, Datenfrequenz und Qualitätschecks fest.','Definiere ein Minimal-Dashboard mit drei Kernsignalen.'], instructions_en:['Choose one measurable physical process.','Define sensor points, data frequency, and quality checks.','Outline a minimal dashboard with three core signals.'], source:'base' },
  { id:'base-54', title_de:'Erstelle ein Compliance-First Framework für ein AI-Produkt', title_en:'Create a compliance-first framework for an AI product', category:'mindset', tags:['solo','reflective','challenge'], duration_min:60, duration_max:120, setting:'indoor', group_mode:'solo', adventure_level:3, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle einen regulierten Bereich (z. B. Health oder Finance).','Definiere die fünf wichtigsten Compliance-Kontrollen.','Leite ab, wie jede Kontrolle im Produkt verankert wird.'], instructions_en:['Pick one regulated domain (for example health or finance).','Define the five most important compliance controls.','Describe how each control is embedded in the product.'], source:'base' },
  { id:'base-55', title_de:'Entwerfe ein ChatGPT-Native SDK Ecosystem als MVP', title_en:'Design a ChatGPT-native SDK ecosystem as an MVP', category:'creativity', tags:['solo','creative','low_budget'], duration_min:75, duration_max:150, setting:'indoor', group_mode:'solo', adventure_level:4, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Bestimme ein Entwicklerproblem, das das SDK löst.','Definiere die kleinste API-Oberfläche mit maximal fünf Endpunkten.','Schreibe ein kurzes Quickstart-Beispiel für den ersten Erfolg in 10 Minuten.'], instructions_en:['Pick one developer problem the SDK solves.','Define the smallest API surface with at most five endpoints.','Write a quickstart that delivers first value in 10 minutes.'], source:'base' },
  { id:'base-56', title_de:'Skizziere eine Autonomous Scientific Discovery Foundry', title_en:'Sketch an autonomous scientific discovery foundry', category:'creativity', tags:['solo','challenge','creative'], duration_min:90, duration_max:180, setting:'indoor', group_mode:'solo', adventure_level:5, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle ein Forschungsfeld mit klar messbarem Ziel.','Definiere den Loop aus Hypothese, Experiment und Auswertung.','Setze Stoppregeln für Sicherheit und Fehlverhalten.'], instructions_en:['Choose one research field with a measurable target.','Design the loop of hypothesis, experiment, and evaluation.','Set stop rules for safety and failure modes.'], source:'base' },
  { id:'base-57', title_de:'Entwirf eine Multimodal Voice Agent Platform für einen Alltagscase', title_en:'Design a multimodal voice agent platform for one daily-life use case', category:'social', tags:['solo','conversation','creative'], duration_min:60, duration_max:120, setting:'indoor', group_mode:'solo', adventure_level:3, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle einen klaren Sprach-Use-Case.','Skizziere Spracheingabe, Kontextspeicher und Antwortkanäle.','Definiere ein Fallback, wenn der Agent unsicher ist.'], instructions_en:['Pick one clear voice use case.','Map voice input, context memory, and response channels.','Define a fallback path for low-confidence responses.'], source:'base' },
  { id:'base-58', title_de:'Konzipiere eine Prompt-Free AI Application Layer', title_en:'Concept a proactive prompt-free AI application layer', category:'creativity', tags:['solo','challenge','creative'], duration_min:60, duration_max:120, setting:'indoor', group_mode:'solo', adventure_level:4, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle drei Situationen, in denen die App proaktiv helfen soll.','Lege Trigger und Grenzen für ungefragte Aktionen fest.','Definiere, wie der Nutzer jederzeit Kontrolle zurückholt.'], instructions_en:['Pick three moments where the app should act proactively.','Define triggers and limits for unprompted actions.','Specify how users can instantly take back control.'], source:'base' },
  { id:'base-59', title_de:'Entwerfe ein AI-Native Industrial Base Manufacturing Playbook', title_en:'Design an AI-native industrial base manufacturing playbook', category:'creativity', tags:['solo','challenge','adventure'], duration_min:90, duration_max:180, setting:'indoor', group_mode:'solo', adventure_level:4, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle eine Fertigungslinie als Beispiel.','Markiere drei Engpässe, die AI lösen könnte.','Schätze Kosten, ROI und Einführungsetappen grob ab.'], instructions_en:['Choose one manufacturing line as your sample.','Identify three bottlenecks AI could improve.','Estimate cost, ROI, and rollout phases at a high level.'], source:'base' },
  { id:'base-60', title_de:'Baue ein Konzept für eine Reasoning-Enabled Multimodal AI Solution', title_en:'Build a concept for a reasoning-enabled multimodal AI solution', category:'creativity', tags:['solo','creative','challenge'], duration_min:75, duration_max:150, setting:'indoor', group_mode:'solo', adventure_level:4, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle ein Problem, das Text, Bild oder Audio kombiniert.','Definiere, wo explizites Reasoning nötig ist.','Beschreibe, wie Fehler erklärt und korrigiert werden.'], instructions_en:['Pick one problem combining text, image, or audio.','Define where explicit reasoning is required.','Describe how errors are explained and corrected.'], source:'base' },
  { id:'base-61', title_de:'Plane ein Industrial Data Annotation and Collection Sprint', title_en:'Plan an industrial data annotation and collection sprint', category:'social', tags:['group','challenge','conversation'], duration_min:60, duration_max:120, setting:'both', group_mode:'group', adventure_level:3, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'any'}, instructions_de:['Definiere Datenschema und Label-Regeln auf einer Seite.','Lege Qualitätsprüfung mit Doppel-Review fest.','Plane ein kurzes Kickoff mit Rollen und Zeitleiste.'], instructions_en:['Define the data schema and labeling rules in one page.','Set up quality checks with double review.','Plan a short kickoff with roles and timeline.'], source:'base' },
  { id:'base-62', title_de:'Simuliere ein Forward-Deployed AI Strategic Consulting Projekt', title_en:'Simulate a forward-deployed AI strategic consulting project', category:'social', tags:['group','conversation','challenge'], duration_min:90, duration_max:180, setting:'both', group_mode:'both', adventure_level:4, equipment:['Notizbuch'], constraints:{budget_max_chf:0,weather_required:'any'}, instructions_de:['Formuliere eine Kundensituation in drei Sätzen.','Erstelle einen 30-60-90-Tage-Plan mit klaren Ergebnissen.','Skizziere Risiken und Kommunikationsrhythmus mit Stakeholdern.'], instructions_en:['Frame a client situation in three sentences.','Build a 30-60-90 day plan with clear outcomes.','Outline risks and stakeholder communication cadence.'], source:'base' },
  { id:'base-63', title_de:'Designe AI Startup Tooling für ein Greenfield-Team', title_en:'Design AI startup tooling for a greenfield team', category:'creativity', tags:['solo','low_budget','creative'], duration_min:60, duration_max:120, setting:'indoor', group_mode:'solo', adventure_level:3, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Definiere den ersten Arbeitsablauf vom Problem bis zum Deploy.','Wähle drei Kern-Tools und begründe sie.','Notiere einen 14-Tage-Umsetzungsplan.'], instructions_en:['Define the first workflow from problem to deployment.','Choose three core tools and justify each one.','Write a 14-day implementation plan.'], source:'base' },
  { id:'base-64', title_de:'Skizziere eine Voice-First AI Operating System Architektur', title_en:'Sketch a voice-first AI operating system architecture', category:'creativity', tags:['solo','creative','challenge'], duration_min:90, duration_max:180, setting:'indoor', group_mode:'solo', adventure_level:5, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Definiere Kernmodule für Wake Word, Intent und Aktionsausführung.','Lege Sicherheitsgrenzen für sensible Befehle fest.','Plane ein Logging-Konzept mit Datenschutzfokus.'], instructions_en:['Define core modules for wake word, intent, and action execution.','Set safety boundaries for sensitive commands.','Plan logging with privacy by design.'], source:'base' },
  { id:'base-65', title_de:'Entwirf ein AI-Powered Contingency Business Model', title_en:'Design an AI-powered contingency business model', category:'mindset', tags:['solo','reflective','challenge'], duration_min:60, duration_max:120, setting:'indoor', group_mode:'solo', adventure_level:3, equipment:['Notizbuch'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle ein Geschäftsmodell mit hohem Risiko.','Definiere Trigger, bei denen der Plan B automatisch aktiviert wird.','Lege Kennzahlen fest, die den Wechsel rechtfertigen.'], instructions_en:['Choose one high-risk business model.','Define triggers that activate a contingency plan.','Set metrics that justify switching paths.'], source:'base' },
  { id:'base-66', title_de:'Entwickle ein High-Context "See Me" Consumer AI Erlebnis', title_en:'Develop a high-context "see me" consumer AI experience', category:'social', tags:['solo','reflective','conversation'], duration_min:75, duration_max:150, setting:'indoor', group_mode:'solo', adventure_level:3, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Definiere, welche Signale das Produkt über den Nutzer lernen darf.','Beschreibe klare Opt-in/Opt-out-Mechanismen.','Schreibe drei Antworten, die Empathie zeigen ohne zu übergriffig zu sein.'], instructions_en:['Define which user signals the product may learn from.','Describe clear opt-in and opt-out controls.','Write three responses that feel empathetic without being intrusive.'], source:'base' },
  { id:'base-67', title_de:'Skizziere ein Synthetic Biology Design and Synthesis Workflow', title_en:'Sketch a synthetic biology design and synthesis workflow', category:'creativity', tags:['solo','challenge','creative'], duration_min:90, duration_max:180, setting:'indoor', group_mode:'solo', adventure_level:5, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle ein sicheres Lehrbeispiel ohne praktische Umsetzung.','Mappe Design-, Simulations- und Review-Schritte auf hoher Ebene.','Notiere explizit ethische und regulatorische Grenzen.'], instructions_en:['Use a safe educational example with no practical execution.','Map design, simulation, and review steps at a high level.','State ethical and regulatory boundaries explicitly.'], source:'base' },
  { id:'base-68', title_de:'Entwirf ein AI-Native Risk Underwriting Insurance Produkt', title_en:'Design an AI-native risk underwriting insurance product', category:'mindset', tags:['solo','challenge','reflective'], duration_min:75, duration_max:150, setting:'indoor', group_mode:'solo', adventure_level:4, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle eine Versicherungsnische.','Definiere ein transparentes Scoring mit Fairness-Kontrollen.','Lege fest, welche Entscheidungen menschlich überprüft werden müssen.'], instructions_en:['Pick one insurance niche.','Define a transparent scoring approach with fairness checks.','Specify which decisions require human review.'], source:'base' },
  { id:'base-69', title_de:'Plane eine AI-Powered Sales Qualification Platform', title_en:'Plan an AI-powered sales qualification platform', category:'social', tags:['group','conversation','challenge'], duration_min:60, duration_max:120, setting:'indoor', group_mode:'both', adventure_level:3, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Definiere klare Kriterien für Lead-Qualität.','Skizziere einen Gesprächsfluss mit Übergabe an Sales.','Lege eine Messung für Präzision und Conversion fest.'], instructions_en:['Define clear lead-quality criteria.','Sketch a conversation flow with handoff to sales.','Set metrics for precision and conversion.'], source:'base' },
  { id:'base-70', title_de:'Skizziere Electro-Industrial Energy Stack Components für ein neues Produkt', title_en:'Sketch electro-industrial energy stack components for a new product', category:'creativity', tags:['solo','adventure','challenge'], duration_min:75, duration_max:150, setting:'indoor', group_mode:'solo', adventure_level:4, equipment:['Laptop'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Wähle ein Energiethema wie Speicher, Umrichter oder Netzsteuerung.','Lege Kernkomponenten und Schnittstellen in einem Blockdiagramm fest.','Definiere ein erstes Pilot-Szenario mit Sicherheitsannahmen.'], instructions_en:['Choose one energy theme such as storage, conversion, or grid control.','Define core components and interfaces in a block diagram.','Describe one pilot scenario with safety assumptions.'], source:'base' },

  { id:'base-71', title_de:'30 Minuten in Stille sitzen und beobachten, was in dir auftaucht', title_en:'Sit in silence for 30 minutes and notice what comes up', category:'mindset', tags:['solo','reflective','challenge'], duration_min:30, duration_max:45, setting:'indoor', group_mode:'solo', adventure_level:2, equipment:['Timer'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['Timer auf 30 Minuten stellen und Benachrichtigungen stummschalten.','Nicht schreiben, nicht lesen, nicht scrollen.','Zum Schluss drei Gedanken notieren, die wiederkamen.'], instructions_en:['Set a 30-minute timer and mute notifications.','Do not write, read, or scroll during the session.','At the end, note three thoughts that kept returning.'], source:'base' },
  { id:'base-72', title_de:'Ohne Ziel loslaufen und 45 Minuten intuitiv durch die Stadt gehen', title_en:'Go on a walk with no destination', category:'outdoor', tags:['solo','adventure','city'], duration_min:30, duration_max:60, setting:'outdoor', group_mode:'solo', adventure_level:2, equipment:['bequeme Schuhe'], constraints:{budget_max_chf:0,weather_required:'any'}, instructions_de:['Nur eine Startzeit festlegen, aber kein Ziel.','An jeder Kreuzung spontan entscheiden.','Eine neue Straße markieren, die du noch nie bewusst gegangen bist.'], instructions_en:['Set only a start time, not a destination.','Choose your direction spontaneously at each intersection.','Mark one street you had never consciously walked before.'], source:'base' },
  { id:'base-73', title_de:'15 Minuten frei ohne Prompt journaln und alles ungefiltert rauslassen', title_en:'Journal without a prompt and let it spill for 15 minutes', category:'mindset', tags:['solo','reflective','journal'], duration_min:15, duration_max:30, setting:'indoor', group_mode:'solo', adventure_level:1, equipment:['Notizbuch'], constraints:{budget_max_chf:0,weather_required:'none'}, instructions_de:['15 Minuten am Stück schreiben, ohne zu stoppen.','Nicht korrigieren und nicht bewerten.','Einen Satz markieren, der dich überrascht hat.'], instructions_en:['Write continuously for 15 minutes without stopping.','Do not edit or judge what you write.','Highlight one sentence that surprised you.'], source:'base' },
  { id:'base-74', title_de:'48 Stunden ohne Social Media verbringen', title_en:'Spend 48 hours without social media', category:'mindset', tags:['solo','challenge','reflective'], duration_min:2880, duration_max:3000, setting:'both', group_mode:'solo', adventure_level:3, equipment:['nichts'], constraints:{budget_max_chf:0,weather_required:'any'}, instructions_de:['Alle Social-Apps ausloggen oder temporär entfernen.','Freie Momente bewusst mit Offline-Aktivitäten füllen.','Nach 48 Stunden notieren, was sich bei Fokus und Stimmung verändert hat.'], instructions_en:['Log out of or temporarily remove all social apps.','Replace idle moments with intentional offline activities.','After 48 hours, note changes in focus and mood.'], source:'base' },
